...
*/
{
  graphitePort: Number(process.env.GRAPHITE_PORT) || Number(process.env.GRAPHITE_PORT_2003_TCP_PORT) || 2003
, graphiteHost: process.env.GRAPHITE_HOST || process.env.GRAPHITE_PORT_2003_TCP_ADDR || undefined
, port: 8125
